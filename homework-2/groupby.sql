...
SELECT DISTINCT country, COUNT(contact_title) as count_suppliers FROM suppliers
GROUP BY country
...
SELECT DISTINCT ship_country, SUM(freight) as sum_freight FROM orders WHERE ship_region IS NOT NULL
